...
mltoken = token_response.json()["SOoRwv8GBuqaE6NCR4YWL1SwplbSQsP-HUAp83k-WlHQ"]

header = {'Content-Type': 'application/json', 'Authorization': 'Bearer ' + mltoken}

payload_scoring = {"input_data": [{"field": ["humidity","K","N","P","ph","rainfall","temperature"], "values": [[80,56,78,78,78,78,78]]}]}
